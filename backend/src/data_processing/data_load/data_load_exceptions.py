from backend.src.data_processing.data_load.stock_info import STOCK_INFO
...
class DataUploadException(Exception):
	...
	def __str__(self):
		return "Failed to Upload CSV file to firebase for {}".format(STOCK_INFO[self._ticker_symbol])